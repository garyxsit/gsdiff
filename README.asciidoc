...
* Implement a mechanism similar to the federated queries of Amazon Athena & Redshift Spectrum to compare internal data with excerpts of WWW data and diff one page and another page on the web
